...
export class BasicNft extends ethereum.SmartContract {
  ...
  getInitialized(): boolean {
    let result = super.call("getInitialized", "getInitialized():(bool)", []);

    return result[0].toBoolean();
  }

  try_getInitialized(): ethereum.CallResult<boolean> {
    let result = super.tryCall("getInitialized", "getInitialized():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
